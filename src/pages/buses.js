...
import hsbc from "../image/bus.jpg";
import idfc from "../image/bus1.jpg";
import snow from "../image/bus2.jpg";
import accor from "../image/bus3.jpg";
import windowImg from "../image/bus4.avif"; 
...
const tabs = [
    ...
    { icon: <MdDirectionsBus size={28} />, label: 'Buses', path: '/buses', new: true, active: true },
        ...
        <div
            ...
            <div className="max-w-6xl mx-auto" style={{ paddingTop: '70px' }}>
                ...
                <div className="bg-white shadow-md  p-0 md:p-6 max-w-6xl mx-auto  space-y-4">
                    <h2 className="text-xl font-bold text-center">Bus Ticket Booking.</h2>

                {/* Search Filters - Buses Booking Layout */}
                <div className="grid grid-cols-1 md:grid-cols-3 border rounded-lg overflow-hidden divide-x text-gray-700 text-sm">
