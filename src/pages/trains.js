...
import hsbc from "../image/train.jpg";
import idfc from "../image/train2.webp";
import snow from "../image/train1.jpeg";
import accor from "../image/train3.webp";
import windowImg from "../image/train4.avif"; 
...
const tabs = [
    ...
    { icon: <MdTrain size={28} />, label: 'Trains', path: '/trains', new: true, active: true },
        ...
        <div
            ...
            <div className="max-w-6xl mx-auto" style={{ paddingTop: '70px' }}>
                ...
                <div className="bg-white shadow-md p-0 md:p-6 max-w-6xl mx-auto space-y-4">
                    ...
                    <span className="font-semibold text-blue-600">Book Train Tickets</span>
                    </label>
                    <label className="flex items-center space-x-2 cursor-pointer">
                    ...
                    <strong>Train Ticket Booking</strong><br />IRCTC Authorized e-ticketing
                    </span>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 border rounded-lg overflow-hidden divide-x text-gray-700 text-sm">
                    ...
                    <h2 className="text-4xl font-bold text-black">New Delhi</h2>
                    <span className="text-xs text-gray-500">NDLS, New Delhi Railway Station</span>
                    </div>

                    {/* To */}
                    <div className="p-4">
                    <p className="text-xs">To</p>
                    <h2 className="text-4xl font-bold text-black">Kanpur</h2>
                    <span className="text-xs text-gray-500">CNB, Kanpur Central</span>
                    </div>

                    {/* Travel Date */}
                    <div className="p-4">
                    <p className="text-xs flex items-center">
                        Travel Date <span className="ml-1 text-blue-500">▼</span>
                    </p>
                    <h2 className="text-4xl font-bold text-black">
                        13 <span className="font-normal">Aug' 25</span>
                    </h2>
                    ...
                    <div className="p-4">
                    <p className="text-xs flex items-center">
                        Class <span className="ml-1 text-blue-500">▼</span>
                    </p>
                    <h2 className="text-4xl font-bold text-black">ALL</h2>
                    <span className="text-xs text-gray-500">All Class</span>
                    </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <div>
                <h2 className="text-md font-bold mb-2">Book Train Tickets Without Any Hassle</h2>
                ...
                <div>
                <h2 className="text-md font-bold mb-2">Easy IRCTC Train Booking</h2>
                <p className="text-gray-700 text-sm leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <div>
                <h2 className="text-md font-bold mb-2">How Book Train Tickets Online with MakeMyTrip</h2>
                <p className="text-gray-700 text-sm leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 gap-8">
                ...
                <div>
                <h2 className="text-md font-bold mb-2">Hassle-free Train Ticket Booking on MakeMyTrip</h2>
                <p className="text-gray-700 text-sm leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <div>
                <h2 className="text-md font-bold mb-2">Q. Why Book Train Tickets Online With MakeMyTrip?</h2>
                <p className="text-gray-700 text-sm leading-relaxed">
                ...
                <div>
                <h2 className="text-md font-bold mb-2">Q. What is the process for booking online train tickets?</h2>
                <p className="text-gray-700 text-sm leading-relaxed">
